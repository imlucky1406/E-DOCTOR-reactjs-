...
const AddDoctor = () => {
    ...
    const onSubmitHandler =async (event) => {
        ...
        try {
            ...
            if (!docImg){
                return toast.error('Image Not Selectel')
            }
      ...
      <div className="bg-white px-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-900">
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Fees</p>
              <input onChange={(e)=> setFees(e.target.value)} value={fees} className="border rounded px-3 py-2" type="num" placeholder="Fees" required />
            </div>
          </div>
            ...
            <div >
                ...
                <textarea onChange={(e)=> setAbout(e.target.value)} value={about} className="w-full px-2 pt2 border rounded"
                type="text"
